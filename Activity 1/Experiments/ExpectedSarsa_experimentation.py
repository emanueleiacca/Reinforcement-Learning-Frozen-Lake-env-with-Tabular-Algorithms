...
#setting up a function that train and evaluate the Expected_SARSA agent
...
if __name__ == "__main__":
    ...
    for step in range(total_steps):
        ...
        qtable_filename = f"qtable_epsilon_expSar{epsilon:.4f}.pickle"

        algo = ExpectedSarsa(env) 

        print(f"Testing ExpectedSarsa with Epsilon={epsilon:.4f}")
