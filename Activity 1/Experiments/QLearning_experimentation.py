...
#setting up a function that train and evaluate the QLearning agent
...
if __name__ == "__main__":
    ...
    for step in range(total_steps):
        ...
        qtable_filename = f"qtable_epsilon_QLearning{epsilon:.4f}.pickle"

        algo = QLearning(env)

        print(f"Testing QLearning with Epsilon={epsilon:.4f}")
