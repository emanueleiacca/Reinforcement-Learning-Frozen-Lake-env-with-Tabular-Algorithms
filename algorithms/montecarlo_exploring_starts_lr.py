import random
from algorithms.common import QTable
from helpers import TensorboardLogger

class Montecarlo_FirstVisit_ExploringStarts_LR:
    ...
    def learn(self, policy, n_steps:int=100, discount_rate=1, lr=0.01, tb_episode_period=100, verbose=False):
        obs = self.env.reset()
        ...
        tblogger = TensorboardLogger("MonteCarloESLR_(dr=" + str(discount_rate) +"-lr=" + str(lr) + ")" , episode_period=tb_episode_period)
